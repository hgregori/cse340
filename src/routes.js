...
import { showProjectsPage, showProjectDetailsPage, showNewProjectForm, processNewProjectForm, showUpdateProjectForm, processEditProjectForm } from './controllers/projects.js';
...
router.get('/update-project/:id', showUpdateProjectForm);
